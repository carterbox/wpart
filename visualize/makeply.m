function makeply( segmentedvol, filenamedir )
...
for phase = 4 %length(OBJ)
if ~isempty(OBJ{phase}) && ~isempty(OBJ{phase}.vertices)
        fprintf('\nSaving object: %s ...', names{phase}); %tic
        fprintf(fid,['ply\n'...
                    'format ascii 1.0\n'...
                    'comment author: Daniel Ching\n'...
                    'comment object: %s\n'...
                    'element vertex %i\n'...
                    'property float x\n'...
                    'property float y\n'...
                    ...
                    'end_header\n']...
                    , names{phase}, numel(OBJ{phase}.vertices), numel(OBJ{phase}.faces));
        
        % Generate a string
        verts = OBJ{phase}.vertices'; %disp(size(verts,1));
        %assert(size(verts,1) == 3);
        string1 = sprintf('%5.5f %5.5f %5.5f\n', verts);
